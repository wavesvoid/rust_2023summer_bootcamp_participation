...
- [x] [Ludwig Stecher: Rusts Module System Explained][2]
- [x] [Tristan Hume: Models of Generics and Metaprogramming: Go, Rust, Swift, D and More][3]
- [x] [Jeff Anderson: Generics Demystified Part 1][4]
- [x] [Jeff Anderson: Generics Demystified Part 2][5]
- [x] [Bradford Hovinen: Demystifying trait generics in Rust][25]
