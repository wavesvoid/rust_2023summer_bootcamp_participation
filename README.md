...
- [x] [1. Concepts][Step 1] (2 weeks)
    - [x] [1.1. Default values, cloning and copying][Step 1.1]
    - [x] [1.2. Boxing and pinning][Step 1.2]
    - [x] [1.3. Shared ownership and interior mutability][Step 1.3]
    - [x] [1.4. Clone-on-write][Step 1.4]
    - [x] [1.5. Conversions, casting and dereferencing][Step 1.5]
    - [x] [1.6. Static and dynamic dispatch][Step 1.6]
    - [x] [1.7. `Sized` and `?Sized` types][Step 1.7]
    - [x] [1.8. Thread safety][Step 1.8]
    - [x] [1.9. Phantom types][Step 1.9]
    - [x] [1.10. Summary Task][Step 1 Summary Task]
- [x] [2. Idioms][Step 2] (2 weeks)
    - [x] [2.1. Rich types ensure correctness][Step 2.1]
    - [x] [2.2. Swapping values with `mem::replace`][Step 2.2]
    - [x] [2.3. Bound behavior, not data][Step 2.3]
    - [x] [2.4. Abstract type in, concrete type out][Step 2.4]
    - [x] [2.5. Exhaustivity][Step 2.5]
    - [x] [2.6. Sealing][Step 2.6]
    - [x] [2.7. Summary Task][Step 2 Summary Task]
