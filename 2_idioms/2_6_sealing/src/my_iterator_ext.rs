...
use core::slice::Iter;
    ...
    pub trait Seal {}
    impl<'a, T> Seal for Iter<'a, T>  {}
}


/// Extension trait for an [`Iterator`].
pub trait MyIteratorExt: Iterator + nine_tail::Seal {
...
// impl<'a> MyIteratorExt for T where T: Iterator + nine_tail::Seal {}
impl<'a, T> MyIteratorExt for Iter<'a, T> {}
